...
_center = (math.ceil(x) - 10, math.ceil(y))
...
oct_Poly, oct_Coords, tep_Cnts = tools.drawOctagon(_img_Grey_Copy, _center, _radius, 0.18, 22.5)   # Draw Octagon into image
...
tools.CountInAreas(tep_Cnts, _ROI_cnts[1])
